...
export default function StudyView() {
  ...
  const [quizDifficulty, setQuizDifficulty] = useState<
    "core" | "intermediate" | "advanced" | "mastery"
  >("core");
  ...
  const loadContent = useCallback(async () => {
    ...
    const fetchKey = `${topicSlug}-${subtopicSlug}`;
          ...
          <div className="card p-6 mb-8">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                >
                  {(["core", "intermediate", "advanced", "mastery"] as const).map((d) => (
                    <button
                      key={d}
                      role="radio"
              ...
              <div className="flex items-start gap-2 text-sm text-foreground/60 italic">
                ...
                <span>
                  {quizDifficulty === "mastery"
                    ? "Mastery Test: Pass to master this lesson and turn it green!"
              ...
              <button
                ...
                className={quizDifficulty === "mastery" ? "btn-primary w-full bg-emerald-600 hover:bg-emerald-700 text-white" : "btn-primary w-full"}
              >
                {quizDifficulty === "mastery" ? "🏆 Start Mastery Test" : "Start Quiz"}
              </button>
            </div>
          </div>
        </div>
