...
import UserAvatar, { AVATAR_OPTIONS, type AvatarId } from "../components/UserAvatar";
import { getLocalProgress, setAvatarId } from "../lib/progress";
import {
  Check,
  Loader2,
  LogOut,
...
export default function Settings() {
  ...
  const [avatarId,   setAvatarState] = useState<string>(() => getLocalProgress(user?.id).avatarId || "dragon_master");
